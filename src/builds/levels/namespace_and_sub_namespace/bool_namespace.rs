...
impl BoolNamespace
{
    ...
    delegate! {
        to self.namespace {
            ...
            pub async fn update_fn<R, FN: FnMut(&mut bool) -> async_graphql::Result<R>>(&self, key: &KeyType, updater: FN) -> async_graphql::Result<R>;

            pub async fn update_kv_fn<R, FN: FnMut(&KeyType, &mut bool) -> async_graphql::Result<R>>(&self, key: &KeyType, updater: FN) -> async_graphql::Result<R>;
            ...
            pub async fn read_fn<R, FN: Fn(&bool) -> async_graphql::Result<R>>(&self, key: &KeyType, reader: FN) -> async_graphql::Result<R>;

            pub async fn read_kv_fn<R, FN: Fn(&KeyType, &bool) -> async_graphql::Result<R>>(&self, key: &KeyType, reader: FN) -> async_graphql::Result<R>;
