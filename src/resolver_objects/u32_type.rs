...
impl U32Query
{
    ...
    pub async fn u32_try_read(&self, ctx: &Context<'_>, key: String) -> Option<u32>
    {
...
impl U32Mutation
{
    ...
    pub async fn u32_insert(&self, ctx: &Context<'_>, key: String, value: u32) -> async_graphql::Result<&'static str>
    {
    ...
    pub async fn u32_update(&self, ctx: &Context<'_>, key: String, value: u32) -> async_graphql::Result<&'static str>
    {
    ...
    pub async fn u32_try_replace(&self, ctx: &Context<'_>, key: String, value: u32) -> Option<u32>
    {
    ...
    pub async fn u32_upsert(&self, ctx: &Context<'_>, key: String, value: u32) -> async_graphql::Result<&'static str>
    {
    ...
    pub async fn u32_remove(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<&'static str>
    {
    ...
    pub async fn u32_try_retrieve(&self, ctx: &Context<'_>, key: String) -> Option<u32>
    {
    ...
    pub async fn u32_add_op(&self, ctx: &Context<'_>, key: String, value: u32) -> async_graphql::Result<u32>
    {
    ...
    pub async fn u32_add_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<u32>
    {
    ...
    pub async fn u32_bit_and_op(&self, ctx: &Context<'_>, key: String, value: u32) -> async_graphql::Result<u32>
    {
    ...
    pub async fn u32_bit_and_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<u32>
    {
    ...
    pub async fn u32_bit_or_op(&self, ctx: &Context<'_>, key: String, value: u32) -> async_graphql::Result<u32>
    {
    ...
    pub async fn u32_bit_or_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<u32>
    {
    ...
    pub async fn u32_bit_xor_op(&self, ctx: &Context<'_>, key: String, value: u32) -> async_graphql::Result<u32>
    {
    ...
    pub async fn u32_bit_xor_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<u32>
    {
    ...
    pub async fn u32_div_op(&self, ctx: &Context<'_>, key: String, value: u32) -> async_graphql::Result<u32>
    {
    ...
    pub async fn u32_div_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<u32>
    {
    ...
    pub async fn u32_mul_op(&self, ctx: &Context<'_>, key: String, value: u32) -> async_graphql::Result<u32>
    {
    ...
    pub async fn u32_mul_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<u32>
    {
    ...
    pub async fn u32_not_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<u32>
    {
    ...
    pub async fn u32_rem_op(&self, ctx: &Context<'_>, key: String, value: u32) -> async_graphql::Result<u32>
    {
    ...
    pub async fn u32_rem_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<u32>
    {
    ...
    pub async fn u32_shl_op(&self, ctx: &Context<'_>, key: String, value: u32) -> async_graphql::Result<u32>
    {
    ...
    pub async fn u32_shl_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<u32>
    {
    ...
    pub async fn u32_shr_op(&self, ctx: &Context<'_>, key: String, value: u32) -> async_graphql::Result<u32>
    {
    ...
    pub async fn u32_shr_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<u32>
    {
    ...
    pub async fn u32_sub_op(&self, ctx: &Context<'_>, key: String, value: u32) -> async_graphql::Result<u32>
    {
    ...
    pub async fn u32_sub_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<u32>
    {
    ...
    pub async fn u32_inc_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<u32>
    {
    ...
    pub async fn u32_dec_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<u32>
    {
