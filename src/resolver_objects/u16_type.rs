...
impl U16Query
{
    ...
    pub async fn u16_get_all_keys(&self, ctx: &Context<'_>) -> HashSet<KeyType>
    {
...
impl U16Mutation
{
    ...
    pub async fn u16_insert(&self, ctx: &Context<'_>, key: KeyType, value: u16) -> async_graphql::Result<&'static str>
    {
        ...
        call_store_method_move_key!(ctx, get_u16_namespace_ref, insert, key, value)
    ...
    pub async fn u16_upsert(&self, ctx: &Context<'_>, key: KeyType, value: u16) -> async_graphql::Result<&'static str>
    {
        ...
        call_store_method_move_key!(ctx, get_u16_namespace_ref, upsert, key, value)
