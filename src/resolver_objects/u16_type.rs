...
impl U16Query
{
    ...
    pub async fn u16_try_read(&self, ctx: &Context<'_>, key: String) -> Option<u16>
    {
...
impl U16Mutation
{
    ...
    pub async fn u16_insert(&self, ctx: &Context<'_>, key: String, value: u16) -> async_graphql::Result<&'static str>
    {
    ...
    pub async fn u16_update(&self, ctx: &Context<'_>, key: String, value: u16) -> async_graphql::Result<&'static str>
    {
    ...
    pub async fn u16_try_replace(&self, ctx: &Context<'_>, key: String, value: u16) -> Option<u16>
    {
    ...
    pub async fn u16_upsert(&self, ctx: &Context<'_>, key: String, value: u16) -> async_graphql::Result<&'static str>
    {
    ...
    pub async fn u16_remove(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<&'static str>
    {
    ...
    pub async fn u16_try_retrieve(&self, ctx: &Context<'_>, key: String) -> Option<u16>
    {
    ...
    pub async fn u16_add_op(&self, ctx: &Context<'_>, key: String, value: u16) -> async_graphql::Result<u16>
    {
    ...
    pub async fn u16_add_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<u16>
    {
    ...
    pub async fn u16_bit_and_op(&self, ctx: &Context<'_>, key: String, value: u16) -> async_graphql::Result<u16>
    {
    ...
    pub async fn u16_bit_and_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<u16>
    {
    ...
    pub async fn u16_bit_or_op(&self, ctx: &Context<'_>, key: String, value: u16) -> async_graphql::Result<u16>
    {
    ...
    pub async fn u16_bit_or_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<u16>
    {
    ...
    pub async fn u16_bit_xor_op(&self, ctx: &Context<'_>, key: String, value: u16) -> async_graphql::Result<u16>
    {
    ...
    pub async fn u16_bit_xor_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<u16>
    {
    ...
    pub async fn u16_div_op(&self, ctx: &Context<'_>, key: String, value: u16) -> async_graphql::Result<u16>
    {
    ...
    pub async fn u16_div_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<u16>
    {
    ...
    pub async fn u16_mul_op(&self, ctx: &Context<'_>, key: String, value: u16) -> async_graphql::Result<u16>
    {
    ...
    pub async fn u16_mul_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<u16>
    {
    ...
    pub async fn u16_not_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<u16>
    {
    ...
    pub async fn u16_rem_op(&self, ctx: &Context<'_>, key: String, value: u16) -> async_graphql::Result<u16>
    {
    ...
    pub async fn u16_rem_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<u16>
    {
    ...
    pub async fn u16_shl_op(&self, ctx: &Context<'_>, key: String, value: u16) -> async_graphql::Result<u16>
    {
    ...
    pub async fn u16_shl_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<u16>
    {
    ...
    pub async fn u16_shr_op(&self, ctx: &Context<'_>, key: String, value: u16) -> async_graphql::Result<u16>
    {
    ...
    pub async fn u16_shr_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<u16>
    {
    ...
    pub async fn u16_sub_op(&self, ctx: &Context<'_>, key: String, value: u16) -> async_graphql::Result<u16>
    {
    ...
    pub async fn u16_sub_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<u16>
    {
    ...
    pub async fn u16_inc_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<u16>
    {
    ...
    pub async fn u16_dec_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<u16>
    {
