...
impl F32Query 
{
    ...
    pub async fn f32_try_read(&self, ctx: &Context<'_>, key: String) -> Option<f32>
    {
    ...
    pub async fn f32_get_all_keys(&self, ctx: &Context<'_>) -> HashSet<String>
    {
...
impl F32Mutation
{
    ...
    pub async fn f32_insert(&self, ctx: &Context<'_>, key: String, value: f32) -> async_graphql::Result<&'static str>
    {
    ...
    pub async fn f32_update(&self, ctx: &Context<'_>, key: String, value: f32) -> async_graphql::Result<&'static str>
    {
    ...
    pub async fn f32_try_replace(&self, ctx: &Context<'_>, key: String, value: f32) -> Option<f32>
    {
    ...
    pub async fn f32_upsert(&self, ctx: &Context<'_>, key: String, value: f32) -> async_graphql::Result<&'static str>
    {
    ...
    pub async fn f32_remove(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<&'static str>
    {
    ...
    pub async fn f32_try_retrieve(&self, ctx: &Context<'_>, key: String) -> Option<f32>
    {
    ...
    pub async fn f32_add_op(&self, ctx: &Context<'_>, key: String, value: f32) -> async_graphql::Result<f32>
    {
    ...
    pub async fn f32_add_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<f32>
    {
    ...
    pub async fn f32_div_op(&self, ctx: &Context<'_>, key: String, value: f32) -> async_graphql::Result<f32>
    {
    ...
    pub async fn f32_div_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<f32>
    {
    ...
    pub async fn f32_mul_op(&self, ctx: &Context<'_>, key: String, value: f32) -> async_graphql::Result<f32>
    {
    ...
    pub async fn f32_mul_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<f32>
    {
    ...
    pub async fn f32_neg_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<f32>
    {
    ...
    pub async fn f32_rem_op(&self, ctx: &Context<'_>, key: String, value: f32) -> async_graphql::Result<f32>
    {
    ...
    pub async fn f32_rem_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<f32>
    {
    ...
    pub async fn f32_sub_op(&self, ctx: &Context<'_>, key: String, value: f32) -> async_graphql::Result<f32>
    {
    ...
    pub async fn f32_sub_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<f32>
    {
    ...
    pub async fn f32_inc_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<f32>
    {
    ...
    pub async fn f32_dec_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<f32>
    {
