...
impl I8Query 
{
    ...
    pub async fn i8_try_read(&self, ctx: &Context<'_>, key: String) -> Option<i8>
    {
    ...
    pub async fn i8_get_all_keys(&self, ctx: &Context<'_>) -> HashSet<String>
    {
...
impl I8Mutation
{
    ...
    pub async fn i8_insert(&self, ctx: &Context<'_>, key: String, value: i8) -> async_graphql::Result<&'static str>
    {

        call_store_method_only_move_key!(ctx, get_i8_namespace_ref, insert, key, value)

    }

    pub async fn i8_update(&self, ctx: &Context<'_>, key: String, value: i8) -> async_graphql::Result<&'static str>
    {
    ...
    pub async fn i8_try_replace(&self, ctx: &Context<'_>, key: String, value: i8) -> Option<i8>
    {
    ...
    pub async fn i8_upsert(&self, ctx: &Context<'_>, key: String, value: i8) -> async_graphql::Result<&'static str>
    {

        call_store_method_only_move_key!(ctx, get_i8_namespace_ref, upsert, key, value)

    }

    pub async fn i8_remove(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<&'static str>
    {
    ...
    pub async fn i8_try_retrieve(&self, ctx: &Context<'_>, key: String) -> Option<i8>
    {
    ...
    pub async fn i8_add_op(&self, ctx: &Context<'_>, key: String, value: i8) -> async_graphql::Result<i8>
    {
    ...
    pub async fn i8_add_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<i8>
    {
    ...
    pub async fn i8_bit_and_op(&self, ctx: &Context<'_>, key: String, value: i8) -> async_graphql::Result<i8>
    {
    ...
    pub async fn i8_bit_and_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<i8>
    {
    ...
    pub async fn i8_bit_or_op(&self, ctx: &Context<'_>, key: String, value: i8) -> async_graphql::Result<i8>
    {
    ...
    pub async fn i8_bit_or_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<i8>
    {
    ...
    pub async fn i8_bit_xor_op(&self, ctx: &Context<'_>, key: String, value: i8) -> async_graphql::Result<i8>
    {
    ...
    pub async fn i8_bit_xor_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<i8>
    {
    ...
    pub async fn i8_div_op(&self, ctx: &Context<'_>, key: String, value: i8) -> async_graphql::Result<i8>
    {
    ...
    pub async fn i8_div_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<i8>
    {
    ...
    pub async fn i8_mul_op(&self, ctx: &Context<'_>, key: String, value: i8) -> async_graphql::Result<i8>
    {
    ...
    pub async fn i8_mul_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<i8>
    {
    ...
    pub async fn i8_neg_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<i8>
    {
    ...
    pub async fn i8_not_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<i8>
    {
    ...
    pub async fn i8_rem_op(&self, ctx: &Context<'_>, key: String, value: i8) -> async_graphql::Result<i8>
    {
    ...
    pub async fn i8_rem_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<i8>
    {
    ...
    pub async fn i8_shl_op(&self, ctx: &Context<'_>, key: String, value: i8) -> async_graphql::Result<i8>
    {
    ...
    pub async fn i8_shl_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<i8>
    {
    ...
    pub async fn i8_shr_op(&self, ctx: &Context<'_>, key: String, value: i8) -> async_graphql::Result<i8>
    {
    ...
    pub async fn i8_shr_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<i8>
    {
    ...
    pub async fn i8_sub_op(&self, ctx: &Context<'_>, key: String, value: i8) -> async_graphql::Result<i8>
    {
    ...
    pub async fn i8_sub_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<i8>
    {
    ...
    pub async fn i8_inc_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<i8>
    {
    ...
    pub async fn i8_dec_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<i8>
    {
