...
impl I16Query
{
    ...
    pub async fn i16_try_read(&self, ctx: &Context<'_>, key: String) -> Option<i16>
    {
    ...
    pub async fn i16_get_all_keys(&self, ctx: &Context<'_>) -> HashSet<String>
    {
...
impl I16Mutation
{
    ...
    pub async fn i16_insert(&self, ctx: &Context<'_>, key: String, value: i16) -> async_graphql::Result<&'static str>
    {

        call_store_method_only_move_key!(ctx, get_i16_namespace_ref, insert, key, value)

    }

    pub async fn i16_update(&self, ctx: &Context<'_>, key: String, value: i16) -> async_graphql::Result<&'static str>
    {
    ...
    pub async fn i16_try_replace(&self, ctx: &Context<'_>, key: String, value: i16) -> Option<i16>
    {
    ...
    pub async fn i16_upsert(&self, ctx: &Context<'_>, key: String, value: i16) -> async_graphql::Result<&'static str>
    {

        call_store_method_only_move_key!(ctx, get_i16_namespace_ref, upsert, key, value)

    }

    pub async fn i16_remove(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<&'static str>
    {
    ...
    pub async fn i16_try_retrieve(&self, ctx: &Context<'_>, key: String) -> Option<i16>
    {
    ...
    pub async fn i16_add_op(&self, ctx: &Context<'_>, key: String, value: i16) -> async_graphql::Result<i16>
    {
    ...
    pub async fn i16_add_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<i16>
    {
    ...
    pub async fn i16_bit_and_op(&self, ctx: &Context<'_>, key: String, value: i16) -> async_graphql::Result<i16>
    {
    ...
    pub async fn i16_bit_and_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<i16>
    {
    ...
    pub async fn i16_bit_or_op(&self, ctx: &Context<'_>, key: String, value: i16) -> async_graphql::Result<i16>
    {
    ...
    pub async fn i16_bit_or_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<i16>
    {
    ...
    pub async fn i16_bit_xor_op(&self, ctx: &Context<'_>, key: String, value: i16) -> async_graphql::Result<i16>
    {
    ...
    pub async fn i16_bit_xor_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<i16>
    {
    ...
    pub async fn i16_div_op(&self, ctx: &Context<'_>, key: String, value: i16) -> async_graphql::Result<i16>
    {
    ...
    pub async fn i16_div_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<i16>
    {
    ...
    pub async fn i16_mul_op(&self, ctx: &Context<'_>, key: String, value: i16) -> async_graphql::Result<i16>
    {
    ...
    pub async fn i16_mul_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<i16>
    {
    ...
    pub async fn i16_neg_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<i16>
    {
    ...
    pub async fn i16_not_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<i16>
    {
    ...
    pub async fn i16_rem_op(&self, ctx: &Context<'_>, key: String, value: i16) -> async_graphql::Result<i16>
    {
    ...
    pub async fn i16_rem_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<i16>
    {
    ...
    pub async fn i16_shl_op(&self, ctx: &Context<'_>, key: String, value: i16) -> async_graphql::Result<i16>
    {
    ...
    pub async fn i16_shl_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<i16>
    {
    ...
    pub async fn i16_shr_op(&self, ctx: &Context<'_>, key: String, value: i16) -> async_graphql::Result<i16>
    {
    ...
    pub async fn i16_shr_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<i16>
    {
    ...
    pub async fn i16_sub_op(&self, ctx: &Context<'_>, key: String, value: i16) -> async_graphql::Result<i16>
    {
    ...
    pub async fn i16_sub_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<i16>
    {
    ...
    pub async fn i16_inc_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<i16>
    {
    ...
    pub async fn i16_dec_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<i16>
    {
