...
impl I32Query
{
    ...
    pub async fn i32_try_read(&self, ctx: &Context<'_>, key: String) -> Option<i32>
    {
    ...
    pub async fn i32_get_all_keys(&self, ctx: &Context<'_>) -> HashSet<String>
    {
...
impl I32Mutation
{
    ...
    pub async fn i32_insert(&self, ctx: &Context<'_>, key: String, value: i32) -> async_graphql::Result<&'static str>
    {

        call_store_method_only_move_key!(ctx, get_i32_namespace_ref, insert, key, value)

    }

    pub async fn i32_update(&self, ctx: &Context<'_>, key: String, value: i32) -> async_graphql::Result<&'static str>
    {
    ...
    pub async fn i32_try_replace(&self, ctx: &Context<'_>, key: String, value: i32) -> Option<i32>
    {
    ...
    pub async fn i32_upsert(&self, ctx: &Context<'_>, key: String, value: i32) -> async_graphql::Result<&'static str>
    {

        call_store_method_only_move_key!(ctx, get_i32_namespace_ref, upsert, key, value)

    }

    pub async fn i32_remove(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<&'static str>
    {
    ...
    pub async fn i32_try_retrieve(&self, ctx: &Context<'_>, key: String) -> Option<i32>
    {
    ...
    pub async fn i32_add_op(&self, ctx: &Context<'_>, key: String, value: i32) -> async_graphql::Result<i32>
    {
    ...
    pub async fn i32_add_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<i32>
    {
    ...
    pub async fn i32_bit_and_op(&self, ctx: &Context<'_>, key: String, value: i32) -> async_graphql::Result<i32>
    {
    ...
    pub async fn i32_bit_and_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<i32>
    {
    ...
    pub async fn i32_bit_or_op(&self, ctx: &Context<'_>, key: String, value: i32) -> async_graphql::Result<i32>
    {
    ...
    pub async fn i32_bit_or_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<i32>
    {
    ...
    pub async fn i32_bit_xor_op(&self, ctx: &Context<'_>, key: String, value: i32) -> async_graphql::Result<i32>
    {
    ...
    pub async fn i32_bit_xor_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<i32>
    {
    ...
    pub async fn i32_div_op(&self, ctx: &Context<'_>, key: String, value: i32) -> async_graphql::Result<i32>
    {
    ...
    pub async fn i32_div_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<i32>
    {
    ...
    pub async fn i32_mul_op(&self, ctx: &Context<'_>, key: String, value: i32) -> async_graphql::Result<i32>
    {
    ...
    pub async fn i32_mul_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<i32>
    {
    ...
    pub async fn i32_neg_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<i32>
    {
    ...
    pub async fn i32_not_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<i32>
    {
    ...
    pub async fn i32_rem_op(&self, ctx: &Context<'_>, key: String, value: i32) -> async_graphql::Result<i32>
    {
    ...
    pub async fn i32_rem_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<i32>
    {
    ...
    pub async fn i32_shl_op(&self, ctx: &Context<'_>, key: String, value: i32) -> async_graphql::Result<i32>
    {
    ...
    pub async fn i32_shl_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<i32>
    {
    ...
    pub async fn i32_shr_op(&self, ctx: &Context<'_>, key: String, value: i32) -> async_graphql::Result<i32>
    {
    ...
    pub async fn i32_shr_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<i32>
    {
    ...
    pub async fn i32_sub_op(&self, ctx: &Context<'_>, key: String, value: i32) -> async_graphql::Result<i32>
    {
    ...
    pub async fn i32_sub_self_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<i32>
    {
    ...
    pub async fn i32_inc_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<i32>
    {
    ...
    pub async fn i32_dec_op(&self, ctx: &Context<'_>, key: String) -> async_graphql::Result<i32>
    {
